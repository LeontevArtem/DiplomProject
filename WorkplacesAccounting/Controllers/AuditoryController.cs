...
namespace WorkplacesAccounting.Controllers
{
    public class AuditoryController : Controller
    {
        ...
        {
            Classes.Auditory model = new Classes.Auditory();
            Data.Action(() =>
            {
                model = Data.AuditoryList.ToList().Find(x => x.Id.ToString() == id);
            });
            return View(model);
        }
        [HttpPost]
        ...
        public IActionResult Info(string id)
        {
            ...
            Data.Action(() =>
            {
                Classes.Auditory model = Data.AuditoryList.Find(x => x.Id.ToString() == id);
            });
